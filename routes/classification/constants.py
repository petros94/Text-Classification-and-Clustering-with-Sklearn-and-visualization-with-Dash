...
LOADING_GENERATE_MODEL = 'classification-loading-1'
LOADING_GENERATE_MODEL_OUTPUT = 'classification-loading-output-1'
...
DROPDOWN_MODELS = 'classification-models-dropdown'

INPUT_MODEL_NAME = 'classification-model-name'

P_TEMP_MODEL_ID = 'classification-temp-model-id'

TEXTAREA_MODEL_PREDICT = 'classification-textarea-state-example'
